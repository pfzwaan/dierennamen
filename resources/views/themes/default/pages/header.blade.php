...
<header class="theme-header shadow-[0_4px_20px_rgba(0,0,0,0.1)] relative z-50">
    <nav
    ...
    >
        <div class="flex items-center justify-between h-20">
            ...
            >
                ...
                <a
                    href="#"
                    class="theme-accent-btn group ml-2 bg-[#F2613F] text-white
        ...
        >
            <div class="flex flex-col px-6 py-6 gap-5
                ...
                <a
                    href="#"
                    class="theme-accent-btn group mt-2 bg-[#F2613F] text-white text-center
                           font-bold text-[16px]
                           py-3 rounded-full
