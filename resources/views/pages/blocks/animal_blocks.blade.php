        ...
        <div class="hidden xl:grid gap-[24px] grid-cols-5 justify-items-center mb-[24px]">
            @for($i = 0; $i < 5; $i++)
                ...
                <div class="h-full w-full rounded-[20px] sm:rounded-[30px] p-[16px] sm:p-[24px] flex flex-col items-center text-center" style="background-color: {{ $desktopBg[$i] }}">
                    ...
                    <a href="{{ $card['url'] ?: '#' }}" class="group mt-auto w-full h-[40px] sm:h-[50px] md:h-[60px] rounded-[100px] bg-[#27304B] text-white text-[12px] sm:text-[14px] font-semibold flex items-center justify-center gap-2 hover:bg-[#1a2235] transition">
